        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              ...
              <a href="mailto:Info@hireuptechcareers.com" className="flex items-center gap-4 text-white/70 hover:text-white transition-colors group">
                ...
                <span className="text-body-sm">Info@hireuptechcareers.com</span>
              </a>

              <div className="flex items-center gap-4 pt-4">
                {[
                  {
                    href: "https://www.linkedin.com/company/hireuptechcareers/",
                    svg: (
                  ...
                  {
                    href: "https://web.whatsapp.com/send?phone=9408548677&text=",
                    svg: (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
